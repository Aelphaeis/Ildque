...
public class SerializerTest {
	...
	public void getAccessibleFieldsAndMethods_fieldAnnotation_ordered() {
		List<AccessibleObject> aos = Serializer.getAccessibleFieldsAndMethods(AnnotatedFieldPerson.class);
	...
	public void sortAccessibles_propType_OrderedProps() {
		...
		List<AccessibleObject> aos = Serializer.getAccessibleFieldsAndMethods(SortedAnnotatedPerson.class);
	...
	public void sortAccessibles_partialElementAnnotation_expect() {
		...
		List<AccessibleObject> aos = Serializer.getAccessibleFieldsAndMethods(clazz);
